...
function Footer(): JSX.Element {
  ...
  const logShortcut = (title: string) => {
    if (title === '식단')
      logger.actionEventClick({ actionTitle: 'CAMPUS', title: 'footer', value: '식단' });
    if (title === '버스/교통')
      logger.actionEventClick({ actionTitle: 'CAMPUS', title: 'footer', value: '버스/교통' });
    if (title === '공지사항')
      logger.actionEventClick({ actionTitle: 'CAMPUS', title: 'footer', value: '공지사항' });
    if (title === '주변상점')
      logger.actionEventClick({ actionTitle: 'BUSINESS', title: 'footer', value: '주변상점' });
    if (title === '복덕방')
      logger.actionEventClick({ actionTitle: 'BUSINESS', title: 'footer', value: '복덕방' });
    if (title === '시간표')
      logger.actionEventClick({ actionTitle: 'USER', title: 'footer', value: '시간표' });
    if (title === '교내 시설물 정보')
    ...
    <footer className={styles.footer}>
      <div className={styles.footer__content}>
        ...
        <div className={styles.sitemap}>
          <Link className={styles.sitemap__logo} to="/">
            <img
