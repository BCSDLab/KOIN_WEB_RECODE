...
function LectureTable({
  ...
  const handleTableRowClick = (value: Lecture | MyLectureInfo, e: React.MouseEvent<HTMLButtonElement>) => {
            ...
            className={cn({
              ...
              [styles['table__row--include']]:
                version === 'semesterLectureList' && myLectures
                  ? myLectures.some(
                      (item) => item.code === lecture.code && item.lecture_class === lecture.lecture_class,
                    )
                  : false,
                ...
                (headerItem, headerItemIndex) =>
                  headerItem.key !== null && (
                    ...
                    >
                      ...
                      {headerItem.key === 'name' && 'name' in lecture && lecture.name}
                      {headerItem.key === 'name' && 'class_title' in lecture && lecture.class_title}
                      {headerItem.key !== null &&
                        headerItem.key !== 'professor' &&
                        headerItem.key !== 'name' &&
