...
export default function AdditionalInfoModal({ closeModal, formData, setFormData }: AdditionalInfoModalProps) {
      ...
      <div className={styles.modal} onClick={(e) => e.stopPropagation()} role="presentation">
        {step === 1 && (
          <div className={styles['modal-content']}>
            ...
            <div className={styles['info-button-container']}>
              ...
              <button className={styles['info-button__confirm']} type="button" onClick={handleNextStep}>
                확인
              </button>
            </div>
          </div>
        ...
        {step === 2 && (
          <div className={styles['modal-content']}>
            ...
            />
            <div className={styles['info-button-container']}>
              <button className={styles['info-button__cancel']} type="button" onClick={() => setStep(1)}>
                취소
              </button>
              <button
