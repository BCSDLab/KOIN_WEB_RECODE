...
const ROUTES = {
  ...
  LostItemDetail: ({ id, isLink }: ROUTESParams<'id'>) => (isLink ? `/lost-item/${id}` : '/lost-item/:id'),
  ...
  LostItemReport: ({ id, isLink }: ROUTESParams<'id'>) => (isLink ? `/lost-item/report/${id}` : '/lost-item/report/:id'),
  Room: () => '/room',
