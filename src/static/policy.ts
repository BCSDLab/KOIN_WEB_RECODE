const PRIVACY_POLICY = [
  ...
  },
  {
    ...
    items: ['전자상거래에서의 계약․청약철회, 대금결제, 재화 등 공급기록 : 5년'],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    content: ["① ('koreatech.in' 이하 '코인')은(는) 다음의 개인정보 항목을 처리하고있습니다.", '1 <일반 회원가입>'],
    items: [
      '필수항목 : 이메일, 로그인ID, 이름, 닉네임, 학번, 학부, 학년',
      '선택항목 : 휴대전화번호, 성별, 소속 동아리, 소속 자치지구, 졸업여부',
    ],
    additionalContent: '2 <자동 수집 항목>',
    additionalItems: ['필수항목 : 서비스 이용 기록, 접속 로그, 접속 IP 정보'],
  },
  {
    id: 5,
    title: '제 5조 (개인정보의 파기)',
  ...
  },
  {
    ...
    content:
      '①이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.',
  },
];
...
const TERMS_OF_SERVICE = [
  ...
  },
  {
    ...
    title: '제 2조 (회원의 정의)',
    content:
      '① 회원이란 코인이 제공하는 서비스에 접속하여 본 약관에 따라 코인의이용절차에 동의하고 코인가 제공하는 서비스를 이용하는 이용자를 말합니다.',
  },
  {
    id: 3,
    title: '제 3조 (회원가입)',
