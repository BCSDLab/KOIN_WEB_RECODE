const PRIVACY_POLICY = [
  {
    ...
    content: '(\'koreatech.in\' 이하 \'코인\') 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.',
    items: [
      '고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인식별. 인증, 회원자격 유지.관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급.배송 등',
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    content: '(\'koreatech.in\' 이하 \'코인\') 은(는) 정보주체의 별도 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조에 해당하는 경우 외에는 개인정보를 제3자에게 제공하지 않습니다.',
  },
  {
    id: 4,
    title: '제 4조 (처리하는 개인정보의 항목 작성)',
    content: [
      '① (\'koreatech.in\' 이하 \'코인\')은(는) 다음의 개인정보 항목을 처리하고있습니다.',
      '1 <일반 회원가입>',
    ],
    items: [
  ...
  },
  {
    id: 5,
    title: '제 5조 (개인정보의 파기)',
    content: '(\'코인\')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다. -파기절차이용자가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류) 내부 방침 및 기타 관련법령에 따라 일정기간 저장된 후 은 즉시 파기됩니다. 이 때, DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는 다른 목적으로 이용되지 않습니다. -파기기한이용자의 개인정보는 개인정보의 보유기간이 경과된 경우에는 보유기간의 종료일로부터 5일 이내에, 개인정보의 처리 목적 달성, 해당 서비스의 폐지, 서비스의 종료 등 그 개인정보가 불필요하게 되었을 때는 개인정보의 처리가 불필요한 것으로 인정되는 날로부터 5일 이내에 그 개인정보를 파기합니다.',
  },
  {
    id: 6,
    title: '제 6조 (개인정보의 안전성 확보 조치)',
    content: [
  ...
  },
  {
    ...
    content: [
      ...
      '▶ 개인정보 보호책임자 성명 : 최원빈 (BCSD Lab Project Leader)',
      '연락처 : chldnjsqls1264@gmail.com ※ 개인정보 보호 담당부서로 연결됩니다.',
      '② 정보주체께서는 BCSD Lab(\'koreatech.in\' 이하 \'코인\')의 서비스를 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. BCSD Lab(\'koreatech.in\' 이하 \'코인\')은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드리겠습니다.',
    ],
  },
  {
    id: 8,
    title: '제 8조 (개인정보 처리방침 변경)',
    content: '①이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.',
  },
];
...
const TERMS_OF_SERVICE = [
  {
    id: 1,
    title: '제 1조 (목적)',
    content: '본 약관은 코인이 제공하는 코인 및 코인 관련 제반 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 코인과 코인과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.',
  },
  {
    id: 2,
    title: '제 2조 (회원의 정의)',
    content: '① 회원이란 코인이 제공하는 서비스에 접속하여 본 약관에 따라 코인의이용절차에 동의하고 코인가 제공하는 서비스를 이용하는 이용자를 말합니다.',
  },
  {
    id: 3,
    title: '제 3조 (회원가입)',
    content: [
      ...
      '2. 6조 제2항에 해당하는 회원 자격 제한 및 정지, 상실을 한 경험이 있었던 경우',
  ...
  {
    id: 10,
    title: '제 10조 (회원의 ID 및 비밀번호에 대한 의무)',
    content: [
