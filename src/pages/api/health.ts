...
export default function health(
  req: NextApiRequest,
  res: NextApiResponse<HealthResponse | HealthErrorResponse | { error: string }>,
) {
  ...
  const expectedEnvironment = Array.isArray(req.query.environment) ? req.query.environment[0] : req.query.environment;
