...
export default function ClubEventCard({ event, setEventId }: ClubEventCardProps) {
  return (
    <div role="button" className={styles['club-event-card']} onClick={() => setEventId(event.id)} tabIndex={0} onKeyDown={() => {}}>
