...
import styles from './NewClubRecruitmentPCView.module.scss';

interface PCViewProps {
  formData: ClubRecruitment;
  setFormData: React.Dispatch<React.SetStateAction<ClubRecruitment>>;
  openModal: () => void;
  setType: Dispatch<SetStateAction<string>>;
}

export default function PCView({
  formData, setFormData, openModal, setType,
}: PCViewProps) {
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <div className={styles['header__button-container']}>
            <button type="button" className={styles.header__button} onClick={() => { setType('cancel'); openModal(); }}>
              생성 취소
            </button>
            <button type="button" className={styles.header__button} onClick={() => { setType('confirm'); openModal(); }}>
              생성 완료
            </button>
          </div>
        </div>
